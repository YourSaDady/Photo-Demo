...
def copy_and_paste(from_path: str, to_path: str, remove: bool = False, photo_format: str = ".jpg"):
    '''
    input: 
    ...
    for file_name in name_list_from:
        ...
        if not os.path.exists(directory1):
            ...
            os.mkdir(directory)
        # final dst path
        full_to_name = directory+f"\\{2-count%2}" + \
            photo_format  # front:1, back:2
...
if __name__ == "__main__":
    ...
    # set to be the same output folder as Canon APP
    from_path = "D:\\test\\working_temp"
    ns = "N"  # to do
    latitude = "38"  # ~
    context = "1"  # ~
